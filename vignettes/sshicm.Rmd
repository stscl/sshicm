...
$$
\textbf{RelE} \left( f_{d_{i}} \mid \mid  f \right) = H \left(f_{d_{i}} , f\right) - H \left(f_{d_{i}}\right) = \sum_{i = 1}^{n} f_{d_{i}} \log_{2} \frac{1}{f} - \sum_{i = 1}^{n} f_{d_{i}} \log_{2} \frac{1}{f_{d_{i}}} = \sum_{i = 1}^{n} f_{d_{i}} \log_{2} \frac{f_{d_{i}}}{f}
$$
